...
<?php 
$qCitesLink = 'index.php?option=com_gpo&controller=citations&type=news&task=frt&action=add'.
		...
		<tr class="<?php echo "row$k"; ?>">
			<td width="40" valign="top" align="center"> 
			    <a style="color:green" target="_blank" 
			       href="index.php?option=com_gpo&controller=news&task=lookup&state=published&id=<?php echo $item->id;?>" 
			...
			<td width="50" valign="top" align="center"> 
			    <?php echo implode(', ', $this->newsModel->getLocations( $item->id, true ) );?>
			</td>
...
function giveFnRWarning( ) {
	...
	var statusVar = 1;
	var qCitesWarning = "These strings have also been found in NCites. Before altering them in News, ";
