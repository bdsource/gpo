...
?>
		<tr class="gpo-row" id="gpo-row-<?php echo $pos; ?>-<?php echo $row['id']; ?>">
			<td class="id"><a href="<?php echo $link_lookup;?>"  title="View News Item"><?php echo $row['id']; ?></a></td>
			<td class="source"><?php echo $row['source']; ?></td>
            <td class="title"><?php echo $row['title']; ?></td>
            <td class="gpnheader"><a href="<?php echo $link_lookup;?>"  title="View News Item"><?php echo $row['gpnheader']; ?></a></td>
			<td class="access">
				<?php echo $access; ?>
			</td>			
