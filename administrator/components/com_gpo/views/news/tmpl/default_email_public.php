...
<?php
	...
	$link_delete = JRoute::_( 'index.php?option=com_gpo&controller=news&task=email_public_remove&id='. $row['id'],false );
...
?>
		<tr class="gpo-row">
			<td class="id warn"><a href="<?php echo $link_lookup;?>"  title="Lookup News Item"><?php echo $row['id']; ?></a></td>
