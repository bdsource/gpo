...
<form method="post" action="<?php echo JRoute::_( 'index.php?option=com_gpo&controller=news'); ?>" id="adminForm" name="adminForm">
...
$optionsArray = $jinput->getVar('swap', false);
  ...
  <table cellpadding="2" cellspacing="2">
	...
	?>
	   <option title="<?php echo $val;?>" 
               ...
               elseif('Public/Member' == $val ){ echo 'share'; }
	                        else{ echo strtolower($val); }?>"
	   <?php if( strtolower($val) == $optionsColumn ){ echo ' selected="selected" ';}elseif($optionsColumn=='share'){ echo ' selected="selected"';}?>
	   >
	           <?php echo $val;?>
	   </option>
	<?php
