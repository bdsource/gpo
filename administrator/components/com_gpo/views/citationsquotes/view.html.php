...
class GpoViewCitationsquotes extends JViewLegacy
{
	var $type='quotes';
	function display($tpl = null)
	{
		GpoHelper::addSubmenu('qcite');
        if (JVERSION >= '3.0')
        {
...
//title
		...
		$text = JText::_( $text );
		$title = JText::_( 'Citations: Quotes <small><small>' . $text.'</small></small>' );
...
//preview
		if( empty( $this->isNew ) )
		{
			...
			$bar->appendButton( 'Custom', '<a class="btn btn-default toolbar-btn-padding" href="' . $href . '" title="Any new changes will not show up on the preview till they have been saved." ><span class="icon-preview"></span>Preview</a>', '' );
		}else{
			$href = JRoute::_( '#',false );
...
/* Moved it in here to try and seperate out the html + javascript a little more */		
	...
	function published()
	{
     $title =  'Citations: Quotes <small><small>[Published]</small></small>' ;
     $title .= $this->getLookupBox();
     JToolBarHelper::title(   JText::_($title), 'generic.png' );
     
                $document = &JFactory::getDocument();
                $document->setTitle(JText::_('Citations: Quotes (QCites) [Published] '));
...
//close to control panel        
        $this->tip_close_to_ctrlpanel();
	...
	{
		 $title =  'Citations: Quotes <small><small>[Unpublished]</small></small>' ;
    $title .= $this->getLookupBox();
		JToolBarHelper::title(   JText::_($title), 'generic.png' );
                
                $document = &JFactory::getDocument();
                $document->setTitle(JText::_('Citations: Quotes (QCites) [Unpublished] '));
...
//published
    ...
    if($isroot){
      $href= "index.php?option=com_gpo&controller=citations&type=quotes&task=publishAll";
      $bar->appendButton('Custom', '<a class="btn btn-default toolbar-btn-padding" href="' . $href . '" title="Publish or re-publish every QCite record in the queue"><span class="icon-unblock"></span>Publish All</a>', '');
    }
//empty unpublished
	...
	{
		JToolBarHelper::title(   JText::_( 'Citations: Quotes <small><small>[Empty Unpublished]</small></small>'  ), 'generic.png' );
                
                $document = &JFactory::getDocument();
                $document->setTitle(JText::_('Citations: Quotes (QCites) [Empty Unpublished] '));
	...
	function publish()
	{
		JToolBarHelper::title(   JText::_( 'Citations: Quotes <small><small>[Publish]</small></small>' ), 'generic.png' );
                
                $document = &JFactory::getDocument();
                $document->setTitle(JText::_('Citations: Quotes (QCites) [Publish] '));
                
		$bar = & JToolBar::getInstance('toolbar');	
//preview
		$url = JRoute::_( 'index.php?option=com_gpo&controller=citations&type=' . $this->type .'&task=preview&id=' . $this->oCitation->id, false );
		$href = "javascript:popup=window.open('" . $url . "','GunPolicyCitation - Preview','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=650,height=600'); popup.focus();";
		$bar->appendButton( 'Custom', '<a class="btn btn-default toolbar-btn-padding" href="' . $href . '" title="Preview"><span class="icon-preview"></span>Preview</a>', '' );		
//edit
		$href = JRoute::_( 'index.php?option=com_gpo&controller=citations&type=' . $this->type . '&task=edit&id=' . $this->oCitation->id, false );
		$bar->appendButton( 'Custom', '<a class="btn btn-default toolbar-btn-padding" href="' . $href . '" title="Edit Citation"><span class="icon-edit"></span>Edit Citation</a>', '' );
...
//close
		$href = JRoute::_( 'index.php?option=com_gpo&controller=citations&type=' . $this->type . '&task=unpublished', false );
		$bar->appendButton( 'Custom', '<a class="btn btn-default toolbar-btn-padding" href="' . $href . '" title="Close Without Saving"><span class="icon-cancel"></span>Close Without Saving</a>', '' );
  ...
  function publishAll(){
    JToolBarHelper::title(   JText::_( 'Citations: Quotes <small><small>[Publish All]</small></small>' ), 'generic.png' );
                $document = &JFactory::getDocument();
                $document->setTitle(JText::_('Citations: Quotes (QCites) [Publish All] '));
    
		$bar = & JToolBar::getInstance('toolbar');	
    $href= "index.php?option=com_gpo&controller=citations&task=unpublished&type=quotes";
    $bar->appendButton( 'Custom', '<a class="btn btn-default toolbar-btn-padding" href="' . $href . '" title="Close Without Saving"><span class="icon-cancel"></span>Close Without Saving</a>', '' );
    $tpl = 'publishall';
		$this->display($tpl);
  }
	...
	function delete()
	{
		JToolBarHelper::title(   JText::_( 'Citations: Quotes <small><small>[Delete]</small></small>' ), 'generic.png' );
                
                $document = &JFactory::getDocument();
                $document->setTitle(JText::_('Citations: Quotes (QCites) [Delete] '));
                
		$bar = & JToolBar::getInstance('toolbar');	
//delete
//		$bar->appendButton( 'Custom', '<a href="#" id="item_delete" title="Delete Quotes Item"><span class="icon-32-delete"</span>Delete</a>', '' );	
//close				
		$href = JRoute::_( 'index.php?option=com_gpo&controller=citations&type=' . $this->type . '&task=published',false );
		$bar->appendButton( 'Custom', '<a class="btn btn-default toolbar-btn-padding" href="' . $href . '" title="Close without deleting"><span class="icon-cancel"></span>Close</a>', '' );
	...
	function search()
	{
		$title = JText::_( 'Citations: Quotes <small><small>[Search]</small></small>' );
		JToolBarHelper::title(   JText::_( $title ), 'generic.png' );	
                
                $document = &JFactory::getDocument();
                $document->setTitle(JText::_('Citations: Quotes (QCites) [Search] '));
		...
		$bar->appendButton( 'Custom', '<a class="btn btn-default toolbar-btn-padding" href="' . $href . '" id="toolbar-Link" title="Search Published QCite"><span class="icon-search"></span>Search</a>', '' );
	...
	function searchResults()
	{
		...
		$href = JRoute::_( 'index.php?option=com_gpo&controller=citations&type=' . $this->type . '&task=search',false );
		$bar->appendButton( 'Custom', '<a class="btn btn-default toolbar-btn-padding" href="' . $href . '" title="Search Published QCite"><span class="icon-search"></span>New Search</a>', '' );
		JToolBarHelper::spacer('10');
	...
	function reindex()
	{
		$title = JText::_( 'Citations: Quotes <small><small>[Update]</small></small>' );
		JToolBarHelper::title(   JText::_( $title ), 'generic.png' );
                
                $document = &JFactory::getDocument();
                $document->setTitle(JText::_('Citations: Quotes (QCites) [Update] '));
	...
	function frt_add()
	{
		...
		JToolBarHelper::title( 'QCites Find & Replace [Search]', 'generic.png' );
                
                $document = & JFactory::getDocument();
		$document->setTitle(JText::_('[QCites] QCites Find & Replace - Add New Search'));
		...
		$LastSearchedLink = 'index.php?option=com_gpo&controller=citations&type=quotes&task=frt&action=add'.
		...
		//history button
		$href = JRoute::_( 'index.php?option=com_gpo&controller=citations&type=quotes&task=frt&action=history',false );
		...
		$href = JRoute::_( 'index.php?option=com_gpo&controller=citations&type=quotes&task=published',false );
		$bar->appendButton( 'Custom', '<a class="btn btn-default toolbar-btn-padding" href="' . $href . '" title="Close: Back to the QCite [Published] Page"><span class="icon-cancel"></span>Close</a>', '' );
	...
	{		
		...
		JToolBarHelper::title( 'QCites Find & Replace [Results]', 'generic.png' );
                
                $document = & JFactory::getDocument();
		$document->setTitle(JText::_('Results - QCites Find & Replace'));
		...
		//JToolBarHelper::back();
		$bar = & JToolBar::getInstance('toolbar');	
		$href = JRoute::_( 'index.php?option=com_gpo&controller=citations&type=quotes&task=frt&action=add',false );
		$bar->appendButton( 'Custom', '<a class="btn btn-default toolbar-btn-padding" href="' . $href . '" title="Close: Back to the Search Form of QCites Find & Replace"><span class="icon-cancel"></span>Cancel</a>', '' );
	...
	{	
		...
		JToolBarHelper::title( 'QCites Find & Replace [History]', 'generic.png' );
                
                $document = & JFactory::getDocument();
		$document->setTitle(JText::_('History - QCites Find & Replace'));
		...
		//close button
		$href = JRoute::_( 'index.php?option=com_gpo&controller=citations&type=quotes',false );
		$bar->appendButton( 'Custom', '<a class="btn btn-default toolbar-btn-padding" href="' . $href . '" title="Close: Back to the QCites [Published] Page"><span class="icon-cancel"></span>Close</a>', '' );
	...
	function tip_reindex()
	{
		if( $this->can_publish && $this->shouldReIndex )
		{
			...
			$bar->appendButton( 'Custom', '<a class="btn btn-default toolbar-btn-padding" href="' . $href . '" title="Update the QCite index to show any recent changes"><span class="icon-upload"></span>Update</a>', '' );
			JToolBarHelper::spacer('10');			
		}
	}
	...
	function tip_search()
	{
		$bar = & JToolBar::getInstance('toolbar');		
		$href = JRoute::_( 'index.php?option=com_gpo&controller=citations&type=' . $this->type .'&task=search', false );
		$bar->appendButton( 'Custom', '<a class="btn btn-default toolbar-btn-padding" href="' . $href . '" title="Search Published QCite Items"><span class="icon-search"></span>Search</a>', '' );
		JToolBarHelper::spacer('10');		
	}
	...
	{
		$bar = & JToolBar::getInstance('toolbar');
		$href = JRoute::_( 'index.php?option=com_gpo&controller=citations&type=quotes&task=frt', false );
		$bar->appendButton( 'Custom', '<a class="btn btn-default toolbar-btn-padding" href="' . $href . '" title="QCites: Find & Replace"><span class="icon-search"></span>Find & Replace</a>', '' );
		JToolBarHelper::spacer('10');
	}
    ...
    /* close to control panel dashboard */ 
    function tip_close_to_ctrlpanel()
	{
		$bar = & JToolBar::getInstance('toolbar');	
		$href = JRoute::_( 'index.php',false );
				
		$bar->appendButton( 'Custom', '<a class="btn btn-default toolbar-btn-padding" href="' . $href . '" title="Close to control panel"><span class="icon-cancel"></span>Close</a>', '' );
	}
    
  
   /* function to add lookup search form in view window */
    function getLookupBox() {
        ...
        $lookupbox = '<small><small>
                    <form style="padding-left:40px;display:inline;" method="post" action="' . JRoute::_("index.php?option=com_gpo", false) . '" id="adminFormLookup" name="adminFormLookup">
                        ...
                        <span>Lookup ID: QC<input type="text" name="'.$name_input_field.'" value="" style="width:50px;"/>
    ...
    function lookup(){
        ...
        $bar = & JToolBar::getInstance('toolbar');		
        JToolBarHelper::title(JText::_('Citations: Quotes (QCites) <small><small>[Lookup]</small></small>' . $this->getLookupBox()), 'generic.png');
        
        $document = & JFactory::getDocument();
	$document->setTitle(JText::_('Citations: Quotes (QCites) [Lookup]'));
                
        $href = JRoute::_('index.php?option=com_gpo&controller=citations&type=' . $this->type .'&task=edit&type='.Joomla\CMS\Factory::getApplication()->getInput()->get('type').'&id='.$this->oCitation->id.'&live_id='.$this->oCitation->live_id, false);
