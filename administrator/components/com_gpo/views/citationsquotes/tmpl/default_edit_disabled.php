...
if( $this->oCitation->published === '0000-00-00 00:00:00' || empty( $this->oCitation->published ) ){ $this->oCitation->published=GpoDefaultPublishTime(); echo "here1"; 
    ...
    $this->oCitation->published = $date->format("F j, Y");
    echo "here3";
...
<div class="row">
	<div style="float:right;padding:0px;margin:0px auto;padding-right:119px;">
		<p>
	...
	<div class="cell">
		<p>
			...
			<input class="input_field published" readonly type="text" id="citations_published" name="citations[published]" value="<?php echo "here"; ?>" />
		</p>
	</div>
</div>
...
<p>
	...
	<input type="text" id="citations_source" name="citations[source]" style="width:750px;" value="<?php
...
<div class="row">
	...
	<p>
		...
		<input class="input_field input120" type="text" id="citations_page" name="citations[page]" value="<?php echo $this->oCitation->page; ?>" />
	</p>
	</div>
</div>
...
<p>
	...
	<textarea class="quotes_custom_content" id="citations_content" name="citations[content]" cols="80" rows="30"><?php
...
<script type="text/javascript">
     jQuery( function() {
    jQuery( "#citations_published" ).datepicker({ dateFormat: 'dd MM yy'});
  } );
</script>