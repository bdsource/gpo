...
?>
		<tr class="<?php echo "row$k"; ?>">
			<td width="40" valign="top" align="center">
			   <a target="_blank" title="Edit this QCite: opens in a New Window" 
			      href="index.php?option=com_gpo&controller=citations&task=edit&type=quotes&live_id=<?php echo $item->id;?>">
                    <?php echo $item->id;?>
               </a>     
			</td>
