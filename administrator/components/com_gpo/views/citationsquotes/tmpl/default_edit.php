...
//echo $this->oCitation->published;
$date_output = 'j M Y';
//Set display output
if( $this->oCitation->published === '0000-00-00 00:00:00' || empty( $this->oCitation->published ) ){ 
	// $this->oCitation->published=GpoDefaultPublishTime();}
	$this->oCitation->published=date('j M Y');}
else{ 
...
<div style="text-align:center;"><h1 style="font-weight:bold"><?php 	echo ( $this->isNew ) ? "Create new QCite" : "Edit this QCite"; ?></h1></div>
<form method="post" action="<?php echo JRoute::_( 'index.php?option=com_gpo&tmpl=component&format=raw'); ?>" id="adminForm" name="adminForm">
...
<div class="row">
	...
	<div style="margin-left:150px;">
		<p>
			...
			<input class="input_field" type="hidden" id="currentdate_hidden" name="citations[currentdate]" value="0" />
			<input class="input_field" type="checkbox" readonly id="currentdate" name="citations[currentdate]" value="1" <?php echo $this->oCitation->currentdate ? "checked='checked'" : ""; ?> />		
		</p>
	</div>	
</div>
...
<p>
	...
	<input type="text" id="citations_source" name="citations[source]" style="width:706px;" value="<?php
...
?>
	...
	<input type="text" id="citations_city" name="citations[city]" style="width:153px;" value="<?php
...
<div class="row">
	...
	<p>
		...
		<input class="input_field input120" type="text" style="width:112px;" id="citations_page" name="citations[page]" value="<?php echo $this->oCitation->page; ?>" />
	</p>
	</div>
</div>
...
<p>
	...
	<textarea id="citations_content" name="citations[content]" style="width:700px;height:425px;"><?php
