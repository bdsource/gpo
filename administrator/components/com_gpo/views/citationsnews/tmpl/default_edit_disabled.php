...
?>
	...
	<input type="text" id="citations_source" name="citations[source]" style="width:745px;" value="<?php
...
<p>
	...
	<textarea id="citations_content" name="citations[content]" cols="80" rows="20"><?php
