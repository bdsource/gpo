...
<form action="index.php?option=com_gpo&amp;controller=citations" method="post" name="adminForm" id="adminForm"
       class="green" onsubmit="javascript: giveFnRWarning();" >
<div class="responsive">
<table class="green adminlist tablesorter table-striped table-hover table-bordered" id="adminlist" width="100%">
...
?>
		<tr class="<?php echo "row$k"; ?>">
			<td width="40" valign="top" align="center">
			   <a target="_blank" title="Edit this NCite: opens in a New Window" 
			      href="index.php?option=com_gpo&controller=citations&task=edit&type=news&live_id=<?php echo $item->id;?>">
                    <?php echo $item->id;?>
               </a>     
			</td>
...
jQuery(document).ready(function() { 
  jQuery('.sort_column_head').click(function(){
    ...
    var sort_image_asc = '<img class="sort_image_asc" alt="" src="/gunpolicy/media/system/images/sort_asc.png">';
    var sort_image_desc = '<img alt="" class="sort_image_desc" src="/gunpolicy/media/system/images/sort_desc.png">';
...
function giveFnRWarning( ) {
	...
	if( boxedCheckedVal > 90 && totalRes > boxedCheckedVal ) {
