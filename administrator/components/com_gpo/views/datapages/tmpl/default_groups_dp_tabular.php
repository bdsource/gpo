...
<form id="adminForm" name="adminForm" method="post" action="<?php echo JRoute::_( 'index.php?option=com_gpo&controller=datapages&task=groups_dp_tabular', false); ?>">
...
<tr>
<td>
<h3> Select a Region/Group: </h3>

<input type="hidden" name="option" value="com_gpo" />
<input type="hidden" name="controller" value="datapages" />
<input type="hidden" name="task" value="groups_dp_tabular" />
...
<table width="100%" border="0" align="left" cellpadding="1" cellspacing="0">    
    ...
    <select disabled="disabled" id="find_country" name="country" title="Find armed violence reduction facts by country " class="inputboxselect" style="width:150px;">
        <option value="">By Country</option>
        <?php echo $options_country; ?>
    </select>
    
    <select id="find_region" name="region"  title="Find armed violence reduction facts by region" class="inputboxselect" style="width:150px;">
        <option value="">By Region</option>
        <?php echo $options_region; ?>
    </select>
    
    
    <select id="find_group" name="group"  title="Find armed violence reduction facts by Conflict, Peace and Security (CPS) investment sectors" class="inputboxselect" style="width:150px;">
        <option value="">By Group</option>
        <?php echo $options_group; ?>
    </select>
    <!-- select box done -->   
