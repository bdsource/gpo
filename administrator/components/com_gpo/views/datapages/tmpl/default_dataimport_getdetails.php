...
<h3>
   DP Update/Write history for ID: <?php echo $this->id;?> / Total Rows Updated: <?php echo count($this->items);?>
</h3>

<table class="adminlist" id="adminList" border="1">
	<thead>
	<tr>
        <th width="5%">SL</th>
		<th width="5%">ID</th>
...
if( count($this->items) ==0):
    echo "<tr><td colspan='11'>Sorry, No replace histories found...</td></tr>";
endif;
?>
...
function highlight(newElem, oldElem){
    var newText = reverseString( newElem.text().trim() );
    var oldText = reverseString( oldElem.text().trim() );
