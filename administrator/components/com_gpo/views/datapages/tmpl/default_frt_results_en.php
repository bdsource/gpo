...
<div class="langPanel">
      <a name="switchLang"></a>
      <h2 style="float:right;margin-top:0px;"> 
          ☞ English Version (Changes made here will also be applied to the corresponding Fr and Es DPs) 
      </h2>
...
<table class="table-striped table-bordered" width="100%" style="font-size:12px;">
	<thead>
    <tr class="info">
		<th colspan="6" valign="top" align="left" style="text-align:left;color:black;">
            <strong> ☞ (To EDIT, click any of the cells in "REPLACE" columns below) </strong>
        </th>
		
        <th align="left" valign="top" align="left" width="20%" style="color:red;">
		   <input type="checkbox" name="dont_replace_es" value="1"  />
           Don't Replace ES DPs 
		</th>
        
        <th align="left" valign="top" align="left" width="20%" style="color:red;">
		   <input type="checkbox" name="dont_replace_fr" value="1"  />
           Don't Replace FR DPs 
		</th>
	</tr>
    </thead>
</table>
...
<table class="adminList table-striped table-hover table-bordered" width="100%" id="adminList">
	...
	<tr class="info">
        ...
        <th width="8%" valign="top" align="center">Column</th>
		<th width="18%" valign="top" align="left">Find</th>
		<th align="left" width="18%" valign="top" align="left">
           <img style="margin:0;float:none;" border="0" src="<?php echo getLanguageFlag('en');?>" />
           Replace 
           <?php echo JText::_(' (').getLanguageName('en').')';?>
		   <small>
        ...
        <th align="left" width="18%" valign="top" align="left">
           ...
           Replace 
           <?php echo JText::_(' (').getLanguageName('es').')';?>
		   <small>
		       <a id="edit_all_es" href="javascript:void(0);" title="click here to open all edit boxes of this category">Edit All</a> 
		   </small>
		</th>
        <th align="left" width="18%" valign="top" align="left">
		   <img style="margin:0;float:none;" border="0" src="<?php echo getLanguageFlag('fr');?>" />
            Replace 
            <?php echo JText::_(' (').getLanguageName('fr').')';?>
		   <small>
		       <a id="edit_all_fr" href="javascript:void(0);" title="click here to open all edit boxes of this category">Edit All</a> 
		   </small>
		</th>
	</tr>
	<tr> 
...
?>
		<tr class="<?php echo "row$k"; ?>">
            ...
            <td width="18%" class="find" valign="top" align="left">
			   <div align="left"><?php echo nl2br($nContent); ?></div>
			</td>
            <!-- EN Items -->
			<td width="18%" class="replace" valign="top" align="left">
			    <div align="left">
                    <?php
			       if( !empty($to) ):
            ...
            <td width="18%" class="replace" valign="top" align="left">
			    <div align="left">
                    <?php
			       if( !empty($to) ):
			          echo nl2br( preg_replace_callback( $replacePattern, "highlight_replace", htmlspecialchars( $this->replacedItems[$key]->content_es, ENT_NOQUOTES ) ));
			       else:
			          echo nl2br( htmlspecialchars( $this->replacedItems[$key]->content_es, ENT_NOQUOTES ) );
			       endif;
			       ?>
			    </div>
               
			   <textarea style="display:none;width:90%;" name="replace_es<?php echo $i;?>" rows="<?php echo $inputRows;?>"><?php echo $this->replacedItems[$key]->content_es;?></textarea>
			</td>
            ...
            <td width="18%" class="replace" valign="top" align="left">
			    <div align="left">
                    <?php
			       if( !empty($to) ):
			          echo nl2br( preg_replace_callback( $replacePattern, "highlight_replace", htmlspecialchars( $this->replacedItems[$key]->content_fr, ENT_NOQUOTES ) ));
			       else:
			          echo nl2br( htmlspecialchars( $this->replacedItems[$key]->content_fr, ENT_NOQUOTES ) );
			       endif;
			       ?>
			    </div>
               
			   <textarea style="display:none;width:90%;" name="replace_fr<?php echo $i;?>" rows="<?php echo $inputRows;?>"><?php echo $this->replacedItems[$key]->content_fr;?></textarea>
			</td>
...
jQuery("#edit_all_es").click(function(event){
    var currentHtml = jQuery(this).html();
	if ( 'Edit All' == currentHtml ) {
  	    showAllEditBox();
	} else {
...
jQuery("#edit_all_fr").click(function(event){
    var currentHtml = jQuery(this).html();
	if ( 'Edit All' == currentHtml ) {
  	    showAllEditBox();
	} else {
...
function changeLabel( newlabel ) {
   ...
   jQuery("#edit_all_es").html(newlabel);
   jQuery("#edit_all_fr").html(newlabel);
}
