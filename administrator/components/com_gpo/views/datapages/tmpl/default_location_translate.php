...
<form method="post" action="<?php echo JRoute::_( 'index.php?option=com_gpo&controller=datapages&task=location_translate'); ?>" id="adminForm" name="adminForm">
...
<div id="dataset" class="dataset">
    <table class="adminlist table-striped table-hover" id="adminList" style="table-layout:fixed;" cellspacing="0px" cellpadding="2px" width="98%">
          <thead>
               <tr>
                  <th width="4%">
                      Loc #ID
...
jQuery(document).ready(function() {
     ...
     var postURL = '<?php echo JRoute::_('index.php?option=com_gpo&controller=datapages&task=location_translate&lang='.$this->currentLanguage,false);?>';
     //console.log(postURL);
