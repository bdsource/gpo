...
$newItem = Joomla\CMS\Factory::getApplication()->getInput()->get('newItem',false);
...
<h3><?php echo $this->oMas->title; ?></h3>
...
<input type="hidden" name="id" value="<?php echo $this->oMas->id; ?>" />
