...
<p>
	<label style="display:block;" for="mas_published_range_from" title="Published From, Search by Date Published hides all items prior to 1970">Published Range: from</label>
	<input class="input_field published" readonly type="text" id="mas_published_range_from" name="published_range[from]" value="<?php echo $this->oMas->published_range->from; ?>" /><button title="Type in DD/MM/YY, and/or select your date from the Date Picker. Searching by Date Published hides all items prior to 1970" id="mas_published_range_from_trigger">*</button> 
</p>
		
<p>
	<label style="display:block;" for="mas_published_range_to" title="Published To, Search by Date Published hides all items prior to 1970">Published Range: to</label>
	<input class="input_field published" readonly type="text" id="mas_published_range_to" name="published_range[to]" value="<?php echo $this->oMas->published_range->to; ?>" /><button title="Type in DD/MM/YY, and/or select your date from the Date Picker. Searching by Date Published hides all items prior to 1970" id="mas_published_range_to_trigger">*</button> <span style="color:#0000ff;">( Do not enter dates before 1970 )</span>
</p>
...
Calendar.setup({
    inputField     :    "mas_published_range_from",     // id of the input field
    ifFormat       :    "%e %b %Y",      // format of the input field
    align          :    "Bl",           // alignment (defaults to "Bl")
    min: 19700101,
    button         : "mas_published_range_from_trigger",
	singleClick	: true
});    
Calendar.setup({
    inputField     :    "mas_published_range_to",     // id of the input field
    ifFormat       :    "%e %b %Y",      // format of the input field
    align          :    "Bl",           // alignment (defaults to "Bl")
    button         : "mas_published_range_to_trigger",
	singleClick	: true
});    
...
<script type="text/javascript">
     jQuery( function() {
    jQuery( "#mas_published_range_from" ).datepicker({ 
        dateFormat: 'dd MM yy',
        changeMonth: true, 
        changeYear: true, 
        yearRange: "-90:+00"
...
<script type="text/javascript">
     jQuery( function() {
    jQuery( "#mas_published_range_to" ).datepicker({ 
        dateFormat: 'dd MM yy',
        changeMonth: true, 
        changeYear: true, 
        yearRange: "-90:+00"
