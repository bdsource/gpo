...
<div id="wrapper">
<div id="header">
	<img src="<?php echo $u->base(); ?>templates/gunpolicy/images/gpo_logo_cit_l.gif" width="531" height="83" alt="gunpolicy.org popup logo"/>
</div>
<div id="content" style="">
    ...
    <h3 style="color:#048DD4;">Search our library of mass media (News) articles, <span style="color: #E8921E;">sorted by Title:</span></h3>

    <?php
    echo generateAlphabetLinks('news');
    echo '<br/><br/>';
    if(!count($citations)){
	...
	<p style="color:#048DD4;">Sorted by Title</p><p>&nbsp;</p>
        ...
        foreach($citations as $citation){
            echo '<li><a style="text-decoration:none;color:black;font-size:80%;" href="/firearms/citation/news/'.$citation->id.'">'.citation_formater($citation, 'n').'</a></li>'.PHP_EOL;
        }
        ?>
        </ul>
        <?php } ?>
