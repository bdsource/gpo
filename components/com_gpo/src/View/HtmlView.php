...
text/x-generic HtmlView.php ( PHP script, ASCII text )
<?php
...
namespace Joomla\Component\Contact\Site\View\Region;
...
use Joomla\Component\Region\Site\Helper\RouteHelper;
...
class HtmlView extends BaseHtmlView
{
     ...
     * @since  4.0.0
     */
    protected $menuItemMatchRegion = false;
