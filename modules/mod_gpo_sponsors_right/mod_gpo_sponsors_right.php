...
$_module = &JModuleHelper::getModule( 'mod_gpo_sponsors_right' );
//$_params = new JParameter( $_module->params );
$_params = new JRegistry($_module->params);

$foo = new modgposponsorshelperright();
$sponsors = $foo->getSponsors();
...
require( JModuleHelper::getLayoutPath('mod_gpo_sponsors_right') );
?>
